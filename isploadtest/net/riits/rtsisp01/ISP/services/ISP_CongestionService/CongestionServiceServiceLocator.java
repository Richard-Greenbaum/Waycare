...
public class CongestionServiceServiceLocator extends org.apache.axis.client.Service implements net.riits.rtsisp01.ISP.services.ISP_CongestionService.CongestionServiceService {
    ...
    public net.riits.rtsisp01.ISP.services.ISP_CongestionService.CongestionService getISP_CongestionService() throws javax.xml.rpc.ServiceException {
    ...
    public net.riits.rtsisp01.ISP.services.ISP_CongestionService.CongestionService getISP_CongestionService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            net.riits.rtsisp01.ISP.services.ISP_CongestionService.ISP_CongestionServiceSoapBindingStub _stub = new net.riits.rtsisp01.ISP.services.ISP_CongestionService.ISP_CongestionServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (net.riits.rtsisp01.ISP.services.ISP_CongestionService.CongestionService.class.isAssignableFrom(serviceEndpointInterface)) {
                net.riits.rtsisp01.ISP.services.ISP_CongestionService.ISP_CongestionServiceSoapBindingStub _stub = new net.riits.rtsisp01.ISP.services.ISP_CongestionService.ISP_CongestionServiceSoapBindingStub(new java.net.URL(ISP_CongestionService_address), this);
                _stub.setPortName(getISP_CongestionServiceWSDDServiceName());
                return _stub;
            }
        }
